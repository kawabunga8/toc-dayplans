...
const styles: Record<string, React.CSSProperties> = {
  ...
  searchBox: { border: `1px solid ${RCS.deepNavy}`, borderRadius: 12, background: RCS.white, marginTop: 8, overflow: 'hidden' },
  searchItem: { display: 'block', width: '100%', textAlign: 'left', padding: 10, border: 0, background: 'transparent', cursor: 'pointer' },
};
