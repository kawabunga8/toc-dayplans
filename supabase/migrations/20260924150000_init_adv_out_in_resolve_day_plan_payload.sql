-- Initialise adv_out in public.resolve_day_plan_payload, matching
-- get_public_day_plan_live (20260924130000). Without it adv_out starts NULL,
-- every `adv_out || ...` stays NULL, and the published_payload snapshot
-- written at publish time drops materials_needed, lesson_overview,
-- assessment_touch_points, pd_goal_connections and first_peoples_principles.
-- Schema-qualified on purpose (ADR-0004).
